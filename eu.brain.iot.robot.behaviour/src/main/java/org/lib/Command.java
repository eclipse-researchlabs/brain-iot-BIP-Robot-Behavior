...
public class Command {
	...
	public int sendStoragePointRequest(int req, int MarkerID){
		...
		RobotBehaviour.sendStoragePointRequest (MarkerID);
	...
	public void openDoorRequest(Integer val, Integer val2) {
		// TODO Auto-generated method stub
		RobotBehaviour.sendOpenDoorRequest( );
	}

	public Integer openDoorResponse(Integer val, Integer val2) {
		int i=0;
		while(i==0) {
			if(RobotBehaviour.response!=null) {
				if(RobotBehaviour.response.currentState == State.OPEN) {
